...
function showCategoriesList(){
    ...
    for(let i = 0; i < currentCategoriesArray.length; i++){
        ...
        if (((minCount == undefined) || (minCount != undefined && parseInt(category.productCount) >= minCount)) &&
            ...
            htmlContentToAppend += `
            <div onclick="setCatID(${category.id})" class="list-group-item list-group-item-action cursor-active category-container">
                <div class="row">
                    <div class="col-3">
                        <img src="${category.imgSrc}" alt="${category.description}" class="img-thumbnail category-img">
                    </div>
                    <div class="col">
